...
namespace mt::model {
	...
	class ModelLoader {
	  public:
		 ...
		 */
		static Model *loadModel(const Ref<mt::io::MTFile> &file);
		 ...
		 */
		static Ref<Model> loadModel_ref(const Ref<mt::io::MTFile> &file);
		 ...
		 * @param file file instance to parse
		 */
		static void loadAnimation(Model *parent, const Ref<mt::io::MTFile> &file);
		 ...
		 * @param file file instance to parse
		 */
		static void loadAnimation(const Ref<Model> &parent, const Ref<mt::io::MTFile> &file);
